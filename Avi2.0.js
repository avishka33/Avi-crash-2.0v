...
//bug database
const { xeontext1 } = require('./virus/xeontext1')
const { xeontext2 } = require('./virus/xeontext2')
const { xeontext3 } = require('./virus/xeontext3')
const { xeontext4 } = require('./virus/xeontext4')
const { xeontext5 } = require('./virus/xeontext5')
const { xeontext6 } = require('./virus/xeontext6')
const wkwk = fs.readFileSync(`./virus/x.mp3`)
const xsteek = fs.readFileSync(`./virus/x.webp`)
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./AVI-Media/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
let audiobuffy = fs.readFileSync(`./AVI-Media/audio/${BhosdikaXeon}.mp3`)
XeonBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaXeon of StickerXeon){
if (budy === BhosdikaXeon){
let stickerbuffy = fs.readFileSync(`./AVI-Media/sticker/${BhosdikaXeon}.webp`)
XeonBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of ImageXeon){
if (budy === BhosdikaXeon){
let imagebuffy = fs.readFileSync(`./AVI-Media/image/${BhosdikaXeon}.jpg`)
XeonBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaXeon of VideoXeon){
if (budy === BhosdikaXeon){
let videobuffy = fs.readFileSync(`./AVI-Media/video/${BhosdikaXeon}.mp4`)
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./AVI-Media/apk/${BhosdikaXeon}.apk`)
sendapk(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./AVI-Media/zip/${BhosdikaXeon}.zip`)
sendzip(buffer)
}
}
...
if (budy === BhosdikaXeon) {
let buffer = fs.readFileSync(`./AVI-Media/doc/${BhosdikaXeon}.pdf`)
senddocu(buffer)
}
}
...
break
            case 'addvideo': {
                ...
                VideoXeon.push(q)
                await fsx.copy(delb, `./AVI-Media/video/${q}.mp4`)
            ...
            case 'delvideo': {
                ...
                fs.writeFileSync('./database/autoreply/video.json', JSON.stringify(VideoXeon))
                fs.unlinkSync(`./AVI-Media/video/${q}.mp4`)
            ...
            case 'addimage': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                ImageXeon.push(q)
                await fsx.copy(delb, `./AVI-Media/image/${q}.jpg`)
            ...
            case 'delimage': {
                ...
                fs.writeFileSync('./database/autoreply/image.json', JSON.stringify(ImageXeon))
                fs.unlinkSync(`./AVI-Media/image/${q}.jpg`)
            ...
            case 'addsticker': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./AVI-Media/sticker/${q}.webp`)
            ...
            case 'delsticker': {
                ...
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerXeon))
                fs.unlinkSync(`./AVI-Media/sticker/${q}.webp`)
            ...
            case 'addvn': {
                ...
                await fsx.copy(delb, `./AVI-Media/audio/${q}.mp3`)
            ...
            case 'delvn': {
                ...
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(`./AVI-Media/audio/${q}.mp3`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
ZipXeon.push(teks)
await fsx.copy(delb, `./AVI-Media/zip/${teks}.zip`)
...
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./AVI-Media/zip/${teks}.zip`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./AVI-Media/apk/${teks}.apk`)
...
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(`./AVI-Media/apk/${teks}.apk`)
...
let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./AVI-Media/doc/${teks}.pdf`)
...
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocXeon))
fs.unlinkSync(`./AVI-Media/doc/${teks}.pdf`)
...
break
case "ytmp3": case "ytaudio": case "song1":
...
if (typemenu === 'v1') {
                    ...
                    XeonBotInc.sendMessage(m.chat, {
      video: fs.readFileSync('./AVI-Media/thumb2.mp4'),
      gifPlayback: true,
      caption: xeonmenuoh,
      contextInfo: {
      externalAdReply: {
